...
import net.classicremastered.minecraft.chat.commands.BlocksCommand;
...
import net.classicremastered.minecraft.chat.commands.ItemCommand;
import net.classicremastered.minecraft.chat.commands.LocateStructureCommand;
import net.classicremastered.minecraft.chat.commands.MobsCommand;
...
public final class CommandRegistry {
    ...
    public static void bootstrap(Minecraft mc) {
        ...
        CommandManager.register(new BlocksCommand());
        CommandManager.register(new ItemCommand());
        CommandManager.register(new MobsCommand());
