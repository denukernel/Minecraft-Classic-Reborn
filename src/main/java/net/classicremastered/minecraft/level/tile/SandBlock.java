...
public final class SandBlock extends Block {
   ...
   private void fall(Level var1, int var2, int var3, int var4) {
      ...
      while(true) {
         ...
         int var10;
         LiquidType var12;
         if(!((var10 = var1.getTile(var11, var8, var6)) == 0?true:((var12 = blocks[var10].getLiquidType()) == LiquidType.WATER?true:var12 == LiquidType.LAVA)) || var5 <= 0) {
            if(var5 != var3) {
               if((var10 = var1.getTile(var11, var5, var6)) > 0 && blocks[var10].getLiquidType() != LiquidType.NOT_LIQUID) {
